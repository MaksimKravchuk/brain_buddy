...
- [x] T057 [P] Add redaction/retention/consent-withdrawal tests for PR-01–PR-09
...
- [x] T058 [P] Add `backend/tests/test_voice_workflow_architecture.py` proving
...
- [x] T061 Update `.env.example` and operator docs for provider selection,
...
- [x] T064 Persist reconciler `provider`, `model`, and `template_version` in
