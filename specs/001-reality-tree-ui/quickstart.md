...
4) Save and exchange  
- Autosave runs locally every ~5s (debounced) and warns before exit; click **Save** to persist to the backend when signed in.  
...
- With a populated tree, opt-in to consent in the inspector, then request AI analysis.  
