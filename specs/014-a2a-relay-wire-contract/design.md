...
| D-03-S21 compact Task rows | task list rendering | Superseded for desktop web by 017 D-03-S17–S23: the fixed control visibly shows agent plus short state, while its accessible name and inline detail retain guarantee tier and cancellation withdrawal. iOS remains as M-03-S24 | "Hermes · Running" (desktop web) | SC-004, FR-013, FR-014; 017-FR-010–FR-012 |
