...
from app.services import NodeService, RelationService, TreeService, ValidationService, VersionService
...
def get_relation_service(container: Container = Depends(get_container)) -> RelationService:
    return container.relation_service


def get_version_service(container: Container = Depends(get_container)) -> VersionService:
    return container.version_service


def get_validation_service(container: Container = Depends(get_container)) -> ValidationService:
