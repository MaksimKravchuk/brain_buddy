...
def test_openapi_documents_precise_error_envelopes(api_client) -> None:
    ...
    expected_error_statuses = {
        ...
        ("/api/brain-dump-operations/{operation_id}/confirm", "post"): {
            "400",
            "401",
            "404",
            "409",
        ...
        ("/api/brain-dump-operations/{operation_id}/consent-decisions", "post"): {
            "400",
            "401",
            "404",
            "409",
        ...
        ("/api/brain-dump-operations/{operation_id}/proposal-batches", "post"): {
            "400",
            "401",
            "404",
            "409",
