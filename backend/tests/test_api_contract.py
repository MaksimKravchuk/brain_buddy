...
def test_openapi_documents_precise_error_envelopes(api_client) -> None:
    ...
    expected_error_statuses = {
        ...
        ("/api/account/delete", "post"): {"401", "403", "422", "429"},
        ...
        ("/api/agent-connections", "post"): {"400", "401", "403", "404", "409", "422"},
        ("/api/agent-connections/{connection_id}", "get"): {"401", "404", "422"},
        ("/api/agent-connections/{connection_id}/test", "post"): {
            "400",
            "401",
            "404",
            "422",
        },
        ("/api/agent-connections/{connection_id}/credential", "post"): {
            "400",
            "401",
            "403",
            "404",
        ...
        ("/api/tasks/{task_id}/agent-runs", "get"): {"401", "404", "422"},
