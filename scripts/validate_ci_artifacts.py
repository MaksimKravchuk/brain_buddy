...
# The mobile campaign (ADR-0015), same shape again. Named here as well as in
# mobile/stryker.config.json so a narrowed allow-list has to change two files,
# one of which CI reads back.
